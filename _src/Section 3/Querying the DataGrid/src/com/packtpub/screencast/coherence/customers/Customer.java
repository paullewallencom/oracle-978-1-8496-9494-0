...
public class Customer implements PortableObject, Serializable, Comparable<Customer> {
	...
	public int compareTo(Customer customer) {
		...
		if ( Long.parseLong(this.getCitizenNo()) > Long.parseLong(customer.getCitizenNo()) )
		{
			return 1;
		}
		else if ( Long.parseLong(this.getCitizenNo()) < Long.parseLong(customer.getCitizenNo()) )
		{
			return -1;
		}
		else return 0;
